<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('Logos') }}
            {{ Form::text('Logos', $empresa->Logos, ['class' => 'form-control' . ($errors->has('Logos') ? ' is-invalid' : ''), 'placeholder' => 'Logos']) }}
            {!! $errors->first('Logos', '<div class="invalid-feedback">:message</div>') !!}
        </div>
